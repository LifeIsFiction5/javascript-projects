...
function init() {
    fetch('https://handlers.education.launchcode.org/static/astronauts.json')
        ...
        .then(data => {
            ...
            document.body.insertBefore(astronautCount, document.getElementById('container'));
            ...
            data.forEach(astronaut => {
                ...
                `;
                container.innerHTML += astronautHTML; //adds astronaut to innerHTML container div.
            });
        })
}
